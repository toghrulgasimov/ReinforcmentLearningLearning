...
def run_cnn():
    ...
    wd1 = tf.Variable(tf.truncated_normal([7 * 7 * 64, 10], stddev=0.03), name='wd1')
    bd1 = tf.Variable(tf.truncated_normal([10], stddev=0.01), name='bd1')
    dense_layer1 = tf.matmul(flattened, wd1) + bd1
    dense_layer1 = tf.nn.relu(dense_layer1)

    # another layer with softmax activations
    wd2 = tf.Variable(tf.truncated_normal([10, 10], stddev=0.03), name='wd2')
    ...
    writer = tf.summary.FileWriter('/home/gasimov/Desktop/Developer/tensor/ant')
